...
class NumberReceiverFacadeTest {
    ...
    @Test
    public void should_return_filed_when_user_gave_more_than_six_numbers(){
        //given
        Set<Integer> numberFromUser = Set.of(1,2,3,4,5,6,8);
        //when
        InputNumberResultDto result = numberReceiverFacade.inputNumbers(numberFromUser);
        //then
        assertThat(result.message()).isEqualTo("failed");
    ...
    @Test
    public void should_return_filed_when_user_gave_at_lest_one_number_out_of_range_of_1_to_99(){
        //given
        Set<Integer> numberFromUser = Set.of(1,2,3,4,5,600);
        //when
        InputNumberResultDto result = numberReceiverFacade.inputNumbers(numberFromUser);
        //then
        assertThat(result.message()).isEqualTo("failed");
